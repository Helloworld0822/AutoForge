...
pub struct App {
    ...
    pub omniroute: Arc<crate::clients::omniroute::OmniRouteClient>,
...
impl App {
    ...
    async fn build(
        ...
        let omniroute = Arc::new(crate::clients::omniroute::OmniRouteClient::new(
            config.omniroute_api_key.clone(),
            config.omniroute_base_url.clone(),
        )?);
